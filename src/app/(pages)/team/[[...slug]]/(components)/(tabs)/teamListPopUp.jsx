...
const TeamListsPopUp = ({tabType, channels, team}) => {
  // console.log('TEAM POP:', tabType, channels, teamOwner)
      ...
      >
        <div className="flex flex-row flex-wrap gap-2 px-2 max-h-[15em] overflow-auto scrollbar-thin">
          {currentChannel.map(channel => (
            <Link 
              href={`/team/${channel.channelName}/${team.teamName}`}
